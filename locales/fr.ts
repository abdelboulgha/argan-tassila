    ...
    items: [
      {
        ...
        name: "Selou au Blé Dur",
        description:
          "Préparation traditionnelle à base de farine de blé dur complet moulue et torréfiée. 100% naturelle et authentique.",
        price: "Sur demande",
        tags: ["farines"],
        image: "/images/products/DSC_8956.JPG",
        imageAlt: "Selou au blé dur",
      },
      {
        id: "soupe-soussia",
        collection: "Farines & Céréales",
        name: "Soupe Soussia (Zemita)",
        description:
          "Mélange nutritif de céréales torréfiées selon la tradition de notre région, idéal pour des repas sains et conviviaux.",
        price: "Sur demande",
        tags: ["farines"],
        image: "/images/products/DSC_8957.JPG",
        imageAlt: "Soupe Soussia Zemita",
      },
      {
        id: "amlou-pistache",
        collection: "Douceurs du Souss",
        name: "Amlou à la Pistache",
        description:
          "Une revisite raffinée de l'amlou traditionnel réunissant pistaches, huile d'argan et miel pur.",
        price: "Sur demande",
        tags: ["amlou"],
        image: "/images/products/DSC_8958.JPG",
        imageAlt: "Amlou à la Pistache",
      },
      {
      ...
      },
      {
        ...
        imageAlt: "Amlou Cacahuète",
      },
      {
        id: "amlou-noir",
        collection: "Douceurs du Souss",
        name: "Amlou Chocolat Noir",
        description:
          "Le mariage irrésistible de l'intensité du cacao et du caractère brut de l'huile d'argan grillée.",
        price: "Sur demande",
        tags: ["amlou"],
        image: "/images/products/DSC_8963.JPG",
        imageAlt: "Amlou Chocolat Noir",
      },
      {
        id: "pack-prestige",
        collection: "Coffrets",
